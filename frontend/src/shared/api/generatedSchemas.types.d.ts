...
export type AdminStationView = { stationId: string, name: string, sortOrder: number, isActive: boolean, hasDevice: boolean, lastSeenAtUtc: (null | string), hasOutstandingInvitation: boolean, isAtAnyFestival: boolean }
...
export type RedeemedEnrolmentView = { deviceId: string, deviceToken: string, staffMember: (null | StaffMemberView), station: (null | StationSummaryView), language: string }
