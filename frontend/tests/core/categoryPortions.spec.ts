...
describe('countCategoryPortions', () => {
  it('counts every portion of an item, not the item once', () => {
    ...
    expect(countCategoryPortions(draft, ITEMS, MAIN_COURSE)).toBe(2)
  })
  ...
  it('adds up the portions of the different items of one category', () => {
    ...
    expect(countCategoryPortions(draft, ITEMS, MAIN_COURSE)).toBe(3)
  })
