...
public sealed class DeviceLanguageService
{
  ...
  private readonly IReadOnlyCollection<string> _supportedLanguages = ["de", "en"];
  ...
  public async Task<Result<ChangedDeviceLanguage, DeviceLanguageFailure>> ChangeAsync(Guid deviceId,
                                                                                      string? language,
                                                                                      CancellationToken cancellationToken)
  {
    ...
    Device? device = await _repository.FindByIdAsync(deviceId, cancellationToken);
