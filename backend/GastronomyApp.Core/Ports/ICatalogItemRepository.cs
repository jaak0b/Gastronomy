...
public interface ICatalogItemRepository
{
  ...
  public Task<IReadOnlyList<ItemStationAssignment>> FindAssignmentsAtFestivalAsync(Guid festivalId,
                                                                                   CancellationToken cancellationToken);
  ...
  public Task<IReadOnlyList<FestivalCatalogItem>> FindMenuRowsAtFestivalAsync(Guid festivalId,
                                                                              CancellationToken cancellationToken);
