...
public interface IFestivalMenuRepository
{
  ...
  public Task<IReadOnlyList<Guid>> FindStationIdsAtFestivalAsync(Guid festivalId,
                                                                 CancellationToken cancellationToken);

  public Task<IReadOnlyList<ItemStationAssignment>> FindAssignmentsAsync(Guid festivalId,
                                                                         Guid catalogItemId,
                                                                         CancellationToken cancellationToken);
