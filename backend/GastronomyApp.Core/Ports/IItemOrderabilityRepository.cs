...
{
  public Task<IReadOnlyList<Guid>> FindActiveStationIdsAtFestivalAsync(Guid festivalId,
                                                                       CancellationToken cancellationToken);

  public Task<IReadOnlyList<Guid>> FindItemIdsPreparedByAsync(Guid festivalId,
