...
public sealed class StationConfiguration : IEntityTypeConfiguration<Station>
{
  public void Configure(EntityTypeBuilder<Station> builder)
  {
    ...
    builder.HasOne(station => station.Device).WithOne().HasForeignKey<Station>(station => station.DeviceId).OnDelete(DeleteBehavior.SetNull);
    builder.HasOne(station => station.EnrolmentInvitation).WithOne().HasForeignKey<Station>(station => station.EnrolmentInvitationId).OnDelete(DeleteBehavior.SetNull);
  }
}
