...
public sealed class LocationTicketConfiguration : IEntityTypeConfiguration<LocationTicket>
{
    public void Configure(EntityTypeBuilder<LocationTicket> builder)
    {
        ...
        builder.Property(ticket => ticket.ProductionLocationId).IsRequired();
        builder.Property(ticket => ticket.LocationSequenceNumber).IsRequired();
        ...
        builder.HasIndex(ticket => new { ticket.OrderId, ticket.ProductionLocationId }).IsUnique();
    }
}
