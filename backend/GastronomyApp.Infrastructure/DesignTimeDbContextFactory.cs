...
public sealed class DesignTimeDbContextFactory : IDesignTimeDbContextFactory<GastronomyAppDbContext>
{
  ...
  {
    DbContextOptions<GastronomyAppDbContext> options = new DbContextOptionsBuilder<GastronomyAppDbContext>().UseSqlite("Data Source=gastronomyapp-design-time.db").Options;
