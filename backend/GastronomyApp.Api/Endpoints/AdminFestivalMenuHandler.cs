...
public sealed class AdminFestivalMenuHandler
{
  ...
  public AdminFestivalMenuHandler(FestivalMenuService service, CatalogChangeAnnouncer announcer, SavedChangeAnnouncement announcement, ResultEnvelope resultEnvelope, ILogger<AdminFestivalMenuHandler> logger)
  {
    _service = service;
