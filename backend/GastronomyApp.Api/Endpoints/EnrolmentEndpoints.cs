...
public sealed class EnrolmentRedemptionHandler
{
                                         ...
                                         CancellationToken cancellationToken)
  {
    ...
    var redemption = await invitationStore.RedeemAsync(new(request.Code,
                                                           request.Name?.Trim(),
    ...
    return redemption.Outcome switch
           {
             ...
             EnrolmentRedemptionOutcome.CodeInvalid => resultEnvelope.Problem(StatusCodes.Status404NotFound,
                                                                              "EnrolmentCodeUnknown",
                                                                              "enrolment.codeUnknown"),
             EnrolmentRedemptionOutcome.CodeExpired => resultEnvelope.Problem(StatusCodes.Status410Gone,
                                                                              "EnrolmentCodeNoLongerValid",
                                                                              "enrolment.codeNoLongerValid"),
             EnrolmentRedemptionOutcome.StaffMemberIsOffTheList => resultEnvelope.Problem(StatusCodes.Status410Gone,
                                                                                          "StaffMemberIsOffTheList",
                                                                                          "enrolment.staffMemberIsOffTheList"),
             EnrolmentRedemptionOutcome.NameRequired => resultEnvelope.Problem(StatusCodes.Status400BadRequest,
                                                                               "ValidationFailed",
                                             ...
                                             CancellationToken cancellationToken)
  {
    ...
    await dispatcher.PushEnrolmentCompletedAsync(new(staffMember.Id, staffMember.Name, device.Id),
                                                 cancellationToken);
