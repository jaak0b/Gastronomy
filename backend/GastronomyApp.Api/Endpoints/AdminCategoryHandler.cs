...
public sealed class AdminCategoryHandler
{
  ...
  public AdminCategoryHandler(CatalogCategoryAdministrationService service, CatalogChangeAnnouncer announcer, SavedChangeAnnouncement announcement, ResultEnvelope resultEnvelope, IMapper mapper)
  {
    _service = service;
