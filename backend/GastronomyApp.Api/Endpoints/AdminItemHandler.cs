...
public sealed class AdminItemHandler
{
  ...
  public AdminItemHandler(CatalogItemAdministrationService service, CatalogChangeAnnouncer announcer, SavedChangeAnnouncement announcement, ResultEnvelope resultEnvelope, ILogger<AdminItemHandler> logger)
  {
    _service = service;
