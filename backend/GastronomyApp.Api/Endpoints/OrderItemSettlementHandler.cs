...
public sealed class OrderItemSettlementHandler
{
  ...
  public OrderItemSettlementHandler(OrderItemSettlementService settlementService,
                                         ...
                                         CancellationToken cancellationToken)
  {
    ...
    Result<SettlementResult, SettlementFailure> settlement =
      await _settlementService.SettleAsync(BuildSettlementRequest(request, caller), cancellationToken);
  ...
  {
    return _announcement.TellTheDevicesWithoutFailingTheSavedChangeAsync(
      cancellationToken => _dispatcher.PushOrderItemsSettledAsync(new(settledIds, tableNames), cancellationToken));
  }
