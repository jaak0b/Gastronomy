...
public sealed class EnrolmentRedemptionHandler
{
  ...
  public async Task<ApiAnswer<RedeemedEnrolmentView>> RedeemAsync(RedeemEnrolmentRequest request, HttpContext httpContext, CancellationToken cancellationToken)
  {
